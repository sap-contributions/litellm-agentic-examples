...
<img src="_static/LiteLLM_SAPGenAIHub.png" alt="LiteLLM SAP GenAI Hub Architecture" />
...
**For detailed instructions on configuring and running the proxy, including Docker setup, please see the [LiteLLM Proxy Setup Guide](_notebooks/PROXY_SETUP.md).**
...
Learn more with our [JavaScript/TypeScript examples](_notebooks/JAVASCRIPT_EXAMPLES.md).
...
The documentation is automatically built and deployed via GitHub Actions on each push to the main branch. To build the documentation locally, follow the instructions in our [Documentation Setup Guide](https://github.com/sap-contributions/litellm-agentic-examples/blob/main/DOCUMENTATION_SETUP.md).
